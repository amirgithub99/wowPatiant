...
public extension JBDatePickerViewDelegate {
    ...
    public var colorForWeekDaysViewText: UIColor { return .black }
    public var fontForWeekDaysViewText: JBFont { return JBFont() }
    public var colorForSelectionCircleForOtherDate: UIColor { return UIColor(red:0.40, green:0.00, blue:0.40, alpha:1.0)
        /*UIColor(red: 81.0/255.0, green: 182.0/255.0, blue: 185.0/255.0, alpha: 1.0)*/ }
    public var colorForSelectionCircleForToday: UIColor { return UIColor(red:0.40, green:0.00, blue:0.40, alpha:1.0)}
        //UIColor(red: 255.0/255.0, green: 98.0/255.0, blue: 89.0/255.0, alpha: 1.0) }
    public var colorForSemiSelectedSelectionCircle: UIColor { return UIColor(red:0.40, green:0.00, blue:0.40, alpha:1.0)
