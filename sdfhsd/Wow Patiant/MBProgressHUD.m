...
//self.backgroundColor = [UIColor whit]
    UIColor *whiteColr = [UIColor blackColor];
    self.backgroundColor = [whiteColr colorWithAlphaComponent:0.3];
...
#pragma mark - Ending IndicationView Animation
- (void)done {
...
#pragma mark - Adding Indicator Vieww
